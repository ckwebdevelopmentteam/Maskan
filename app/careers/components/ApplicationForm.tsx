...
export default function ApplicationForm({ isOpen, jobTitle, onClose }: ApplicationFormProps) {
  const [isSubmitting, setIsSubmitting] = useState(false);
  const formSubmitUrl = "https://formsubmit.co/info@strategixuae.com"; // Placeholder email
