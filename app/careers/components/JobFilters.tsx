    ...
    <div className="flex flex-col md:flex-row gap-6 mb-16 max-w-2xl">
      ...
      <div className="relative flex-1">
        <select 
          ...
          className="w-full bg-transparent border border-black/20 text-black rounded p-4 outline-none focus:border-black transition-colors duration-300 appearance-none cursor-pointer"
        >
