...
export default function ElementisStory() {
  return (
    <div id="portfolio" className="overflow-x-hidden bg-[var(--bg-primary)] px-6 py-12 text-[var(--fg-primary)] md:px-16 md:py-36 flex flex-col gap-16 md:gap-20 border-t border-[var(--border-white-5)]">
