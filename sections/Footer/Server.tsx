  ...
  return (
    <footer className="w-full bg-black text-white font-sans border-t border-white/10">
      ...
      <div className="px-6 md:px-16 py-4 flex flex-col md:flex-row md:items-center gap-8 md:gap-0 border-b border-white/10">
        ...
        <div className="flex-1 grid grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link href="/blog" className="text-sm text-white/80 hover:text-white transition-colors">Blog</Link>
          </div>
          ...
          <div className="flex flex-col gap-3 col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-2 mt-2">
              <a suppressHydrationWarning href="https://www.facebook.com/Maskan-builders-106170434940334" target="_blank" rel="noopener noreferrer"
                aria-label="Maskan Builders on Facebook"
              ...
              <a suppressHydrationWarning href="https://twitter.com/LlpMaskan" target="_blank" rel="noopener noreferrer"
                aria-label="Maskan Builders on Twitter"
                className="flex items-center justify-center w-8 h-8 bg-white/5 rounded-full border border-white/10 hover:bg-white/15 transition-colors">
              ...
              <a suppressHydrationWarning href="https://www.instagram.com/maskanbuildersanddevelopers/" target="_blank" rel="noopener noreferrer"
                aria-label="Maskan Builders on Instagram"
                className="flex items-center justify-center w-8 h-8 bg-white/5 rounded-full border border-white/10 hover:bg-white/15 transition-colors">
              ...
              <a suppressHydrationWarning href="https://wa.me/917594033300" target="_blank" rel="noopener noreferrer"
                aria-label="Maskan Builders on WhatsApp"
                className="flex items-center justify-center w-8 h-8 bg-white/5 rounded-full border border-white/10 hover:bg-white/15 transition-colors">
      ...
      <div className="px-6 md:px-16 py-4 flex flex-col md:flex-row justify-between items-center gap-2 text-xs text-white/30 font-medium">
        <p suppressHydrationWarning>© 2025 MASKAN®. All rights reserved.</p>
        <a suppressHydrationWarning href="https://www.thynck.in" target="_blank" rel="noopener noreferrer" className="hover:text-white/60 transition-colors">
