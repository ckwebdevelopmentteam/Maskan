...
export default function Footer() {
  return (
    <footer className="w-full bg-black text-white pt-12 pb-8 px-6 md:px-16 flex flex-col font-sans border-t border-white/5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 md:gap-8 mb-10 md:mb-12">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 text-sm font-medium">
            <a href="tel:+917594033300" className="hover:opacity-70 transition-opacity">+91 75940 33300</a>
            <a href="mailto:maskanplans@gmail.com" className="hover:opacity-70 transition-opacity">maskanplans@gmail.com</a>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 text-sm font-medium mb-4">
          ...
          <div className="flex items-center gap-4 text-sm mt-1">
            ...
            <a href="https://twitter.com/LlpMaskan" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity flex items-center justify-center bg-white/5 p-2 rounded-full border border-white/10 hover:bg-white/10">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" /></svg>
            </a>
            <a href="https://www.instagram.com/maskan_builders/" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity flex items-center justify-center bg-white/5 p-2 rounded-full border border-white/10 hover:bg-white/10">
      ...
      {/* Giant MASKAN Logo */}
      <div className="w-full flex justify-center items-center py-4 md:py-6 mb-6 border-b border-white/10">
