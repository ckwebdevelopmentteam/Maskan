...
export default function ClipImageCard({
  ...
  return (
    <motion.div
      ...
      style={{ ...style }}
      className={cn(
        "relative z-10 flex h-full flex-col items-center justify-between py-[8vh] text-[#DCD4C4] backdrop-brightness-[60%] md:flex-row md:px-16 md:py-[15vh]",
        className,
      )}
    >
      ...
      <motion.div
        ...
        className="relative z-20 my-[5vh] flex h-[70vh] min-h-fit w-[90%] flex-col items-center gap-8 bg-[#DCD4C4] p-5-75 text-[#2B3530] md:h-full md:max-h-172 md:w-full md:max-w-118 md:px-8 md:py-4"
      >
        ...
        <div className="relative aspect-[1.62] w-full overflow-hidden md:aspect-[1.85] border border-[#2B3530]/10 p-1 bg-white/50">
