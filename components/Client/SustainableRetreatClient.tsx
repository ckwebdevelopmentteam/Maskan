...
export default function SustainableRetreatClient() {
  ...
  return (
    <>
      ...
      <div className="-mx-8-25 grid grid-rows-5 divide-y divide-[var(--fg-primary)] border-y border-[var(--fg-primary)] md:col-span-2 md:col-start-2 md:row-start-2 md:mx-0">
